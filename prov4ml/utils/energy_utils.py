...
CARBON_INTENSITY = pd.read_csv('https://raw.githubusercontent.com/matbun/ProvML/refs/heads/new-main/prov4ml/utils/carbon_intensity.csv').set_index("Energy Source").transpose()
ENERGY_MIX = pd.read_csv('https://raw.githubusercontent.com/matbun/ProvML/refs/heads/new-main/prov4ml/utils/energy_mix_percs.csv').set_index("Country code")
